...
```
git clone https://gitflic.ru/project/salixsorbus/tusurlatexpreamble.git
cd tusurlatexpreamble
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/salixsorbus/tusurlatexpreamble.git
git clone
